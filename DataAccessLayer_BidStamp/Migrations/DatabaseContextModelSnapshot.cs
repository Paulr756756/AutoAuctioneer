...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccessLayer_BidStamp.Models.Car", b =>
                {
            ...
            modelBuilder.Entity("DataAccessLayer_BidStamp.Models.CarPart", b =>
                {
            ...
            modelBuilder.Entity("DataAccessLayer_BidStamp.Models.Listing", b =>
                {
            ...
            modelBuilder.Entity("DataAccessLayer_BidStamp.Models.User", b =>
                {
                    b.Property<Guid>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DataAccessLayer_BidStamp.Models.CustomizationPart", b =>
                {
                    b.HasBaseType("DataAccessLayer_BidStamp.Models.CarPart");
            ...
            modelBuilder.Entity("DataAccessLayer_BidStamp.Models.Engine", b =>
                {
                    b.HasBaseType("DataAccessLayer_BidStamp.Models.CarPart");
            ...
            modelBuilder.Entity("DataAccessLayer_BidStamp.Models.IndividualCarPart", b =>
                {
                    b.HasBaseType("DataAccessLayer_BidStamp.Models.CarPart");
            ...
            modelBuilder.Entity("DataAccessLayer_BidStamp.Models.Car", b =>
                {
                    b.HasOne("DataAccessLayer_BidStamp.Models.User", "User")
                        .WithMany("Cars")
            ...
            modelBuilder.Entity("DataAccessLayer_BidStamp.Models.Listing", b =>
                {
                    b.HasOne("DataAccessLayer_BidStamp.Models.Car", "Car")
                        .WithOne("Listing")
                        .HasForeignKey("DataAccessLayer_BidStamp.Models.Listing", "CarId")
                        .OnDelete(DeleteBehavior.ClientCascade);

                    b.HasOne("DataAccessLayer_BidStamp.Models.CarPart", "CarPart")
                        .WithOne("Listing")
                        .HasForeignKey("DataAccessLayer_BidStamp.Models.Listing", "CarPartId")
                        .OnDelete(DeleteBehavior.ClientCascade);
            ...
            modelBuilder.Entity("DataAccessLibrary_BidStamp.Models.Bid", b =>
                {
                    b.HasOne("DataAccessLayer_BidStamp.Models.Listing", "Listing")
                        .WithMany("Bids")
            ...
            modelBuilder.Entity("DataAccessLayer_BidStamp.Models.CustomizationPart", b =>
                {
                    b.HasOne("DataAccessLayer_BidStamp.Models.CarPart", "CarPart")
                        ...
                        .HasForeignKey("DataAccessLayer_BidStamp.Models.CustomizationPart", "CarpartId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DataAccessLayer_BidStamp.Models.Engine", b =>
                {
                    b.HasOne("DataAccessLayer_BidStamp.Models.CarPart", "CarPart")
                        .WithOne("Engine")
                        .HasForeignKey("DataAccessLayer_BidStamp.Models.Engine", "CarpartId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DataAccessLayer_BidStamp.Models.IndividualCarPart", b =>
                {
                    b.HasOne("DataAccessLayer_BidStamp.Models.CarPart", "CarPart")
                        ...
                        .HasForeignKey("DataAccessLayer_BidStamp.Models.IndividualCarPart", "CarpartId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();

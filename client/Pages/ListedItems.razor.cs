...
partial class ListedItems
{
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        if (listingsResponse != null) Listings = listingsResponse;
    }

    private async Task<List<ListingResponse>?> GetResponse()
    {
        var response = await _genericMethods.GetValuesFromApi<ListingResponse>(EnvUrls.GetListings);

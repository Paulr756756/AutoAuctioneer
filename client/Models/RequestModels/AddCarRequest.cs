...
//Basic Attributes
    [JsonPropertyName("make")] [Required] public string Make { get; set; }

    [JsonPropertyName("model")] [Required] public string Model { get; set; }

    [Required]
    [JsonPropertyName("year")]
    [MaxLength(4, ErrorMessage = "Cannot be greater than 4")]
    [MinLength(4, ErrorMessage = "Cannot be smaller than 4")]
    public string Year { get; set; }

    [JsonPropertyName("vin")] public string VIN { get; set; }

    [JsonPropertyName("color")] [Required] public string Color { get; set; }
